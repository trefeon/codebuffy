...
export function render(container, deps) {
  ...
  container.innerHTML = ""
    ...
    + '            </select>'
    + '          </div>'
    + '          <div class="hint">Radius 14px · Shadows soft · Font system sans (ui-sans-system) · Theme 520ms mix (prefers-reduced-motion honors shell) · locale stored as <code>localePreference</code> + <code>admin-locale</code></div>'
